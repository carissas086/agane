<div class="container-fluid gal-project empty-scroll" id="gal-misc">
    <div class="row">
    ...
    <div class="gal flex flex-vertcen row">
        <a class="gal-link col-12 col-md-3" href="design/portrait.php#misc-1">
            ...
            <div class="gal-img" id="gal-portrait"></div>
        </a>
        <a class="gal-link col-12 col-md-3" href="images/cs_ace.jpg"
            data-lightbox="misc"
            data-title="An illustration I did of a man who is his heart, offering it up." >
        ...
        <a class="gal-link col-12 col-md-3" href="images/cs_interest.jpg"
            data-lightbox="misc"
